...
public class adminRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        adminIDTxtBox = new javax.swing.JTextField();
        ...
        jLabel5.setText("NIC :-");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 370, 20));

        adminIDTxtBox.setBackground(new java.awt.Color(204, 204, 204));
        adminIDTxtBox.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        adminIDTxtBox.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(0, 0, 0)));
        jPanel2.add(adminIDTxtBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 50, 360, 40));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 370, 20));
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        if (nicTxtBox.getText().trim().equals("")) {
        ...
        } else if (adminIDTxtBox.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Please Enter Student ID");
            adminIDTxtBox.grabFocus();
            ...
            try {
                ...
                if (JOptionPane.showConfirmDialog(f, "Are all the details correct") == JOptionPane.YES_NO_OPTION) {
                    ...
                    String serach = "Select Count(adminID) from admin where adminID = '" + adminIDTxtBox.getText() + "'";
                    ...
                    if (intRs == 1) {
                        ...
                        String registerStudent = "Insert into admin (adminID, Name, NIC, DOB, Mobile, Email, Password) values ('" + adminIDTxtBox.getText() + "', '" + fullNameTxtBox.getText() + "', '" + nicTxtBox.getText() + "', '" + birthDay + "', '" + mobileTxtBox.getText() + "', '" + emailTxtBox.getText() + "', '" + passwordPwdBox.getText() + "')";
    ...
    private javax.swing.JTextField adminIDTxtBox;
